...
dump_file = random.choice([x for x in os.listdir("/public/dumps/public/enwiki/latest") if "-pages-articles" in x and os.path.isfile(os.path.join("/public/dumps/public/enwiki/latest", x))])
